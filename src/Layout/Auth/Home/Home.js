            ...
            <View style={styles.container}>
              ...
              <ImageBackground source={require('../../../../assets/imagenes/Login_Background_White.png')} style={{flex: 1, resizeMode:'cover', justifyContent: 'center'}}>
                ...
                <View style={styles.containerLogin} >
                  ...
                  <Card.Content style={styles.containerButtonLogin} >
                  <Button icon="book-outline" mode="contained" color={'#B10909'} onPress={() => navigation.navigate('CreateActivities')} style={{height:45, justifyContent: 'center', alignItems: 'center'}}>
                    Crear actividades
                  </Button>
                </Card.Content>
